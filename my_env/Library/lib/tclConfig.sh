...
# installed.
TCL_PREFIX='S:/end_to_end_ML/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='S:/end_to_end_ML/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='S:/end_to_end_ML/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IS:/end_to_end_ML/myenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LS:/end_to_end_ML/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='S:/end_to_end_ML/myenv\Library\lib\tclstub86.lib'
